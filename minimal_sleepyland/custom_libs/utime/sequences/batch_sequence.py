...
class BatchSequence(BaseSequence):
    ...
    def __init__(self,
        ...
        Args:
            ...
            batch_scaler:      (string) The name of a sklearn.preprocessing
                                        ...
                                        batch (optional)
            get_spectrogram:   (str)    If set, spectrogram data will be computed
    ...
    def batch_shape(self):
        ...
        n_periods = self.margin * 2 + 1 if self.margin != 100 else self.margin * 2 # lseq requires even n_periods
        return [self.batch_size, n_periods,
    ...
    def get_period(self, sleep_study, period_idx, allow_shift_at_border=True,
        ...
        n_periods = margin*2+1 if margin != 100 else margin*2 # lseq requires even n_periods
